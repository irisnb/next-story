...
- FROM: `### Requirement: No AI or background automation writes user notebooks in this change`
- TO: `### Requirement: AI and background automation never write user notebooks`
