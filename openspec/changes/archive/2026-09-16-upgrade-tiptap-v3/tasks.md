...
- [x] 3.8 按 git-master 规范提交阶段二（`6767708 chore: 完成Tiptap 3.31.3安全迁移`）

## 4. 收尾

- [x] 4.1 确认 GitHub Dependabot 两条 `@tiptap/core` 警报已消除；豁免记录转为历史备注（推送后开放警报由 3 条降至 2 条，仅余既定 `time` / `glib`）
- [x] 4.2 同步更新 `方向/全量地基审计-2026-09-14.md` 第八节 5b 行状态与处理进度摘要
- [x] 4.3 `openspec` 严格校验通过，具备归档条件
